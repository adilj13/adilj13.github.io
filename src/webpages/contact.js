                    ...
                    <div class="py-4 px-4 mx-auto max-w-screen-xl">
                        ...
                        <div class="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
                            <div>
                                ...
                                <h3 class="mb-2 text-xl font-bold dark:text-white">Chat on X</h3>
                                <p class="text-gray-500 dark:text-gray-400">Primary option to contact me is on X. Inbox me on my <a href="https://x.com/adilj13" class="text-black dark:text-white" target="_blank" rel='noreferrer'>X profile</a>.</p>
                            </div>
                            <div>
                                <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                                ...
                                <p class="text-gray-500 dark:text-gray-400">Sufi Engineering, 24-Safdar Town, Lahore Road, Okara.</p>
                            </div>
                            {/* <div>
                                <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">

        ...
        return (
            ...
            <div className="sm:container sm:mx-auto p-4 max-w-md lg:grid lg:grid-cols-4 lg:gap-8 min-h-[100vh]" >
                <div className="text-gray-700 dark:text-white max-w-3xl w-full col-span-3 text-lg">
                    ...
                    <h4 className=' text-2xl font-semibold my-4'>Software</h4>
                    <ul className='list-disc list-inside'>
                        <li className=''>This website is hosted on <a className='hover:bg-blue-500 hover:text-white dark:hover:text-gray-700 text-blue-500' href='https://pages.cloudflare.com/'>Cloudflare Pages</a>, uses the <a href='https://reactjs.com' className='hover:bg-blue-500 hover:text-white dark:hover:text-gray-700 text-blue-500'>Reactjs</a> and styled with <a href='https://tailwindcss.com' className='hover:bg-blue-500 hover:text-white dark:hover:text-gray-700 text-blue-500'>Tailwind CSS</a>.</li>
                    ...
                    <h4 className=' text-2xl font-semibold my-4'>Hardware</h4>
                    <ul className='list-disc list-inside'>
                        <li className=''><b>PC</b>: <a className='hover:bg-blue-500 hover:text-white dark:hover:text-gray-700 text-blue-500' href='https://www.hp.com/us-en/shop/mdp/elitebook-840'>HP Elitebook 840</a></li>
                        <li className=''><b>Monitor</b>: <a className='hover:bg-blue-500 hover:text-white dark:hover:text-gray-700 text-blue-500' href='https://www.asus.com'>ASUS (x2)</a></li>
                    </ul>
                </div>
                <div className="max-w-3xl w-full col-span-1">
                    <div className="my-4 bg-slate-300  dark:bg-slate-800 p-4 max-w-3xl rounded-xl w-full">
                        <h4 className="mb-3 text-xl font-semibold tracking-tight text-gray-700 dark:text-white">ABOUT ME</h4>
                    ...
                    <div className="bg-slate-300  dark:bg-slate-800 p-4 max-w-3xl rounded-xl w-full">
                        <h4 className="mb-3 text-xl font-semibold tracking-tight text-gray-700 dark:text-white">DETAILS</h4>
